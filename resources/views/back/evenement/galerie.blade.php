    ...
    <div class="row">
        <div class="col-md-4">
            <x-back.card
                    ...
                    title='Evenement'>
                <ul class="list-group">
                    <li class="list-group-item">Titre    : <strong>{{ $evenement->titre }}</strong> </li>
                    <li class="list-group-item">Date de creation : <strong>{{ formatDate($evenement->date_creation) }}</strong> </li>

                </ul>
            </x-back.card>

            <div class="row justify-content-start m-2">
                <a href="{{ route('evenement.create', ['ok' => 1]) }}"
        ...
        <div class="col-md-8">
            <x-back.card
                ...
                <form action="{{ route('evenement.galeries.upload', ['evenement' => $evenement->id]) }}"
                      method="post"
                      class="dropzone"
                      data-delete="{{ route('evenement.galeries.delete', ['evenement' => $evenement->id]) }}"
                ...
                @if(count($evenement->galerie) > 0)
                    <x-back.card
                        ...
                        <div class="owl-carousel owl-theme">
                            @foreach($evenement->galerie as $galerie)
                                <div class="item">
