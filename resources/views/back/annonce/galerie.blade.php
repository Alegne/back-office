    ...
    <div class="row">
        <div class="col-md-4">
            <x-back.card
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item">Approuve : <strong>{{ $annonce->approuve ? 'OUI' : 'NON' }}</strong> </li>
            ...
            <div class="row justify-content-start m-2">
                <a href="{{ route('annonce.create', ['ok' => 1]) }}"
        ...
        <div class="col-md-8">
            <x-back.card
                ...
                <form action="{{ route('annonce.galeries.upload', ['annonce' => $annonce->id]) }}"
                      method="post"
                      class="dropzone"
                      data-delete="{{ route('annonce.galeries.delete', ['annonce' => $annonce->id]) }}"
